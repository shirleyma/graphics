...
Material* json_parse_material(const jsonvalue& json) {
    ...
    json_set_optvalue(json, material->normal_mapping, "normal_mapping"); // normal_mapping
    return material;
}
...
Scene* json_parse_scene(const jsonvalue& json) {
    ...
    json_set_optvalue(json, scene->isRussian, "isRussian");
    json_set_optvalue(json, scene->isBlurry, "isBlurry");
    json_set_optvalue(json, scene->depth_of_field, "depth_of_field");
