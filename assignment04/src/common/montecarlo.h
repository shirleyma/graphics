...
inline pair<vec3f,float> sample_cosine(vec3f norm, vec2f ruv) {
...
inline pair<vec3f,float> sample_brdf(vec3f kd, vec3f ks, float n, vec3f v, vec3f norm, vec2f ruv, float rl) {
