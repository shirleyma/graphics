...
struct Material {
    ...
    bool        normal_mapping = false; // use normal mapping
};
...
struct Scene {
    ...
    bool                isRussian = false;  // Russian roulette
    bool                isBlurry = false;   // Blurry reflection
    bool                depth_of_field = false;     //depth of field
    bool                isMipmap = false;   // Mip map
